...
http_archive(
    ...
    sha256 = "23a3028a04bbd09e1f1fd0bcd21e93cfda3805a304df996e55331ecc070e27be",
    strip_prefix = "rules_sass-1.49.10",
    urls = [
        "https://github.com/bazelbuild/rules_sass/archive/1.49.10.zip",
    ],
)
